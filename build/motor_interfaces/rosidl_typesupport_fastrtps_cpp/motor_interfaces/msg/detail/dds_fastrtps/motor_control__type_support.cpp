...
#include "motor_interfaces/msg/detail/motor_control__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const motor_interfaces::msg::MotorControl & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  motor_interfaces::msg::MotorControl & ros_message)
{
  // Member: device
  cdr >> ros_message.device;
...
{
  auto typed_message =
    static_cast<const motor_interfaces::msg::MotorControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<motor_interfaces::msg::MotorControl *>(
    untyped_ros_message);
...
{
  return max_serialized_size_MotorControl(full_bounded, 0);
}
...
{
  return &motor_interfaces::msg::typesupport_fastrtps_cpp::_MotorControl__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, motor_interfaces, msg, MotorControl)() {
  return &motor_interfaces::msg::typesupport_fastrtps_cpp::_MotorControl__handle;
}
